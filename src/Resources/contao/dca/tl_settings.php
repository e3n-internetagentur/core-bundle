...
(
	...
	(
		...
		'allowMultiAutologin' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['allowMultiAutologin'],
			'inputType'               => 'checkbox',
		),
		'allowedTags' => array
		(
